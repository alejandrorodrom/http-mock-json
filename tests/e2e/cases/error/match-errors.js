  ...
  run: () => runUseCase({
    ...
    expected: {
      ...
      stdoutIncludes: [
        ...
        'The "match" property must include "params", "query", "body", "headers", "multipart" and/or "call"',
        ...
        'A "match.call" with only "reset": true must also include "params", "query", "body", "headers" and/or "multipart"',
        ...
        'The "match.headers" property must be an object',
        'The "match.headers" property must not be empty',
        'The "match.multipart" property must be an object',
        'The "match.multipart" property must not be empty'
      ],
